#
# OMNeT++/OMNEST Makefile for TCP_con_control_analysis
#
# This file was generated with the command:
#  opp_makemake -f --deep -O out -KINET4_5_PROJ=../inet4.5 -KTCP_CON_CONTROL_ANALYSIS_PROJ=. -DINET_IMPORT -I. -I$$\(INET4_5_PROJ\)/src -L$$\(INET4_5_PROJ\)/src -lINET$$\(D\)
#

# Name of target to be created (-o option)
TARGET_DIR = .
TARGET_NAME = TCP_con_control_analysis$(D)
